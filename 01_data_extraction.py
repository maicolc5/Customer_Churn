...
ComprasHistoricas AS (
    SELECT
        ...
        COALESCE(DATEDIFF(DAY, ho.last_order_date, f.FechaCorteOriginal), 0) AS days_since_last_purchase,
        COALESCE(DATEDIFF(DAY, ho.first_order_date, f.FechaCorteOriginal), 0) AS days_since_first_purchase,
